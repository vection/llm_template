...
class JsonGenerator(BaseGenerator):
    ...
    def __init__(self, model: PreTrainedModel, tokenizer: PreTrainedTokenizer, max_tokens: int = 512,
    ...
    def generate(self, inputs: Union[str, list], template: dict) -> Union[str, dict]:
        ...
        for ind, temp_tokens in enumerate(templates_tokens):
            ...
            if '[' in temp_instance_type:
                generated_ids = self.model.generate(
                    inputs=inputs,
                    max_new_tokens=self.max_tokens_generation,
